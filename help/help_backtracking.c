...
void help_backtracking_menu(void)
{
    ...
    printf("PROBLEM STATEMENT:\n");
    printf("     Given a string of N distinct characters, generate all possible\n");
    printf("     permutations of the string. A permutation is an arrangement of\n");
    printf("     all characters where the order of the characters matters.\n\n");
    printf("ALGORITHM (permute):\n");
    printf("   - Uses recursive backtracking to generate all permutations.\n");
    printf("   - The algorithm fixes one character at a time starting from the\n");
    printf("     current index.\n");
    printf("   - For each position, it swaps the current character with every\n");
    printf("     character from the current index to the end of the string.\n");
    printf("   - After the recursive call returns, the swap is undone to restore\n");
    printf("     the previous state before trying the next character.\n");
    printf("   - When the current index reaches the string length, a complete\n");
    printf("     permutation has been formed and is counted as a solution.\n\n");
    printf("BACKTRACKING STEPS:\n");
    printf("   1. CHOOSE - Select a character for the current position by swapping.\n");
    printf("   2. EXPLORE - Recursively generate permutations for the remaining\n");
    printf("      positions.\n");
    printf("   3. BACKTRACK - Undo the swap and restore the string to its previous\n");
    printf("      state before trying the next character.\n");
    printf("   4. COMPLETE - When all positions are fixed, record the permutation.\n\n");
    printf("VISUALIZER WALKTHROUGH:\n");
    printf("   - Enter a string using the standard string-input convention.\n");
    printf("   - The visualizer displays the current recursion state as characters\n");
    printf("     are selected for each position.\n");
    printf("   - Selected characters are highlighted in green.\n");
    printf("   - Unselected positions are represented by red underscores.\n");
    printf("   - Each recursive call corresponds to a new level in the recursion tree.\n");
    printf("   - Watch characters being selected as the algorithm moves deeper into\n");
    printf("     the tree and restored as it backtracks.\n");
    printf("   - When a complete permutation is reached, it is displayed as a\n");
    printf("     generated solution and the solver continues with the next branch.\n");
    printf("   - The total number of generated permutations is displayed after\n");
    printf("     the visualization completes.\n\n");
    printf("WHAT TO OBSERVE:\n");
    printf("   - For a string of length N, there are N choices for the first\n");
    printf("     position, N-1 choices for the second, and so on.\n");
    printf("   - This produces N! total permutations for N distinct characters.\n");
    printf("   - The same string is modified through swaps and restored after each\n");
    printf("     recursive call. This restoration step is the BACKTRACK operation.\n");
    printf("   - Observe how returning from a recursive call causes the previous\n");
    printf("     character arrangement to be restored before another choice is made.\n");
    printf("   - The recursion tree grows factorially, so the interactive\n");
    printf("     visualization is limited to small input strings.\n");
    printf("   - For this visualizer, keep the input length at 5 or below to avoid\n");
    printf("     excessive output and animation time.\n\n");
    ...
    printf("String              O(N*N!)             N! permutations are generated.\n");
    printf("Permutation                             Each permutation requires O(N)\n");
    printf("                                        work to construct/display.\n\n");
