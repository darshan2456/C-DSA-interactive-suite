...
### 3. Elementary Sorting Algorithms $\mathcal{O}(N^2)$ (Menu Option 3 → 1)
...
### 4. Advanced Sorting Algorithms $\mathcal{O}(N \log N)$ (Menu Option 3 → 2)
| Algorithm | Category | Time Complexity (Best / Avg / Worst) | Space Complexity | Description |
| :--- | :--- | :--- | :--- | :--- |
...
### 6. Graph Traversals & Pathfinding (Menu Option 5 → 1)
...
### 7. Advanced Graph Algorithms (Menu Option 5 → 2)
| Algorithm | Category | Time Complexity | Space Complexity | Description |
| :--- | :--- | :--- | :--- | :--- |
...
### 9. Dynamic Programming (Menu Option 11)
...
### 10. Advanced Heaps & Priority Queues (Menu Option 13)
...
### 12. Probabilistic Data Structures (Menu Option 15)
...
### 13. Spatial & Multi-Dimensional Indexing (Menu Option 16)
...
### 14. Error Correction & Integrity Algorithms (Menu Option 8)
| Algorithm | Category | Time Complexity | Space Complexity | Description |
| :--- | :--- | :--- | :--- | :--- |
...
### 15. Process Synchronization Simulators (Menu Option 9 → 2)
...
### 16. Cache Simulator & Eviction Policies (Menu Option 18)
...
### 17. Backtracking Algorithms (Menu Option 10)
| Algorithm / Problem | Category | Time Complexity | Space Complexity | Description |
| :--- | :--- | :--- | :--- | :--- |
...
### 18. Hashing & Collision Resolution (Menu Option 6)
...
### 19. CPU & Job Scheduling Algorithms (Menu Option 9 → 1)
...
### 20. Bit Manipulation & Bitwise Operations (Menu Option 14)
...
### 21. System Utilities: Telemetry, Memory Inspector & Serialization (Menu Options 17, 19)
